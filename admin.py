...
from .models import (
    ...
    CertificateType, CertificateApplication, CertificateDistribution, CertificateFeeCollection,
    LibraryInventory, LibraryMember, LibraryFineCollection, BookIssued,
    Grievance, Feedback, Enquiry, ContactUs
)
...
admin.site.register(CertificateDistribution)
admin.site.register(CertificateFeeCollection)
